...
@NamedQueries({
    ...
    , @NamedQuery(name = "UserRole.findByIDUser", query = "SELECT u FROM UserRole u WHERE u.userRolePK.iDUser = :iDUser")})
public class UserRole implements Serializable {
    ...
    public UserRole(String role, String iDUser) {
        this.userRolePK = new UserRolePK(role, iDUser);
    }
    ...
    public String toString() {
        return "Class.UserRole[ userRolePK=" + userRolePK + " ]";
    }

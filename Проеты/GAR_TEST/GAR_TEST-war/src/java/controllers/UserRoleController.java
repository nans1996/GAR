...
public class UserRoleController implements Serializable {
    ...
    public UserRole getSelected() {
        if (current == null) {
            ...
            current.setUserRolePK(new DAO.UserRolePK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public UserRole getUserRole(DAO.UserRolePK id) {
    ...
    public static class UserRoleControllerConverter implements Converter {
        ...
        DAO.UserRolePK getKey(String value) {
            DAO.UserRolePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new DAO.UserRolePK();
            key.setRole(values[0]);
            key.setLogin(values[1]);
            return key;
        }

        String getStringKey(DAO.UserRolePK value) {
